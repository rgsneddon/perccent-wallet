...
class WalletAttribution extends StatefulWidget {
  const WalletAttribution({
    super.key,
  ...
  @override
  State<WalletAttribution> createState() => _WalletAttributionState();
}

class _WalletAttributionState extends State<WalletAttribution> {
  ...
  void initState() {
    ...
    _russellTap = TapGestureRecognizer()
      ..onTap = () => _launch(WalletAttribution.russellUrl);
    _royTap = TapGestureRecognizer()
      ..onTap = () => _launch(WalletAttribution.royUrl);
    _beamTap = TapGestureRecognizer()
      ..onTap = () => _launch(WalletAttribution.beamUrl);
  }
