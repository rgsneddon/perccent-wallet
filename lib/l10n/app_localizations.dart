...
final _en = {
  ...
  'nav_credit': 'Credit',
  'security_intro':
      'Backup protects your wallet identity. Export an encrypted file, import a prior backup, or recover with your 12-word seed phrase — one coherent Backup journey on this tab.',
  'security_export_title': '1. Export encrypted backup',
  'security_export_note':
      'Save a portable encrypted .percbackup file with your full ledger (balances, scenarios, stash). Keep the passphrase somewhere safe — you will need it to import.',
  'security_export_action': 'Export backup file',
  'security_restore_title': '2. Import backup file',
  'security_restore_note':
      'Choose a previously exported .percbackup file and enter the passphrase you used when exporting. This replaces the local ledger on this device.',
  'security_restore_action': 'Import backup file',
  'security_seed_title': '3. Recover from seed phrase',
  'security_seed_note':
      'If you saved the optional 12-word phrase at registration (or Suite setup), paste it here to restore the same wallet identity without a file.',
